...
export const articles1: Article1[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1581092162562-40038f70bada?w=800&h=500&fit=crop",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1581092160562-40038f40bada?w=800&h=500&fit=crop",
  ...
  },
  {
    ...
    excerpt:
      "Cómo elegir la bomba de vacío correcta según tus necesidades industriales.",
    content:
      "Seleccionar la bomba de vacío adecuada requiere considerar varios factores: velocidad de bombeo, rango de presión final, tipo de gas a bombearse, temperatura de operación y compatibilidad química. Este artículo proporciona un marco de decisión claro con ejemplos de aplicaciones reales en industrias como alimentación, química, electrónica y farmacéutica.",
    image:
      "https://images.unsplash.com/photo-1581092162562-40038f70bada?w=800&h=500&fit=crop",
  ...
  },
  {
    ...
    excerpt:
      "Comparación detallada entre bombas turbomoleculares y bombas rotativas.",
    content:
      "Las bombas turbomoleculares y las bombas rotativas son dos tecnologías distintas con diferentes ventajas. Las turbomoleculares alcanzan vacíos más altos pero requieren bombas de respaldo, mientras que las rotativas son más simples y económicas para aplicaciones de medio vacío. Analizamos en detalle las características de cada una y cuándo usar cada tipo.",
    image:
      "https://images.unsplash.com/photo-1581092162562-40038f70bada?w=800&h=500&fit=crop",
