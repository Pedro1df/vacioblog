...
export const articles: Article[] = [
  ...
  },
  {
    ...
    excerpt:
      "Descubre las características más importantes de React 19 y cómo mejorarán tu desarrollo.",
    content:
    ...
    image:
      "https://images.unsplash.com/photo-1633356122544-f134324ef6e9?w=800&h=500&fit=crop",
    author: "Carlos López",
  ...
  },
  {
    ...
    excerpt:
      "Domina las promesas, async/await y callbacks en JavaScript moderno.",
    content:
      "JavaScript asincrónico puede ser confuso al principio, pero es esencial para cualquier desarrollador web moderno. Este artículo te guía a través de callbacks, promesas y async/await, mostrando ejemplos prácticos y casos de uso reales. Entenderás cuándo usar cada patrón y cómo evitar errores comunes como el callback hell.",
    image:
      "https://images.unsplash.com/photo-1633356122544-f134324ef6e9?w=800&h=500&fit=crop",
  ...
  },
  {
    ...
    excerpt:
      "Construye interfaces hermosas rápidamente con Tailwind CSS utility-first approach.",
    content:
      "Tailwind CSS revoluciona la forma en que escribimos CSS al adoptar un enfoque utility-first. En lugar de escribir clases CSS personalizadas, usamos utilidades predefinidas que podemos combinar para crear diseños complejos. Este artículo explora cómo Tailwind puede aumentar tu productividad, mantener la consistencia en el diseño y hacer tu código más mantenible.",
    image:
      "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&h=500&fit=crop",
